...
public class OutputStreamDoubler extends OutputStream {
    ...
    public static void main(String[] args) {
        try (FileOutputStream fos1 = new FileOutputStream("src\\main\\java\\ueb15\\aufgabe4\\file1.txt");
             FileOutputStream fos2 = new FileOutputStream("src\\main\\java\\ueb15\\aufgabe4\\file2.txt");
